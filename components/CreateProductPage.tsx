      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-[15px]">
            {isEditMode ? 'Cập nhật thông tin chi tiết cho sản phẩm của bạn.' : 'Điền các thông tin chi tiết bên dưới.'}
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <FormField icon={FileText} label="Mô tả" description="Mô tả ngắn gọn về sản phẩm/dịch vụ." placeholder="Nhập mô tả..." value={description} onChange={(e) => setDescription(e.target.value)} isTextarea />
