            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden sticky top-6">
                <div className="p-2 space-y-1">
                    <button 
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 text-[14px] font-medium rounded-lg transition-colors ${activeTab === 'prompts' ? 'bg-[#E8FCF3] text-[#0EB869]' : 'text-slate-600 hover:bg-slate-50'}`}
                    >
                        <Terminal size={18} />
                        Prompt Config
                    </button>
                    <button 
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 text-[14px] font-medium rounded-lg transition-colors ${activeTab === 'general' ? 'bg-[#E8FCF3] text-[#0EB869]' : 'text-slate-600 hover:bg-slate-50'}`}
                    >
                        <User size={18} />
                        General
                    </button>
                    <button 
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 text-[14px] font-medium rounded-lg transition-colors ${activeTab === 'notifications' ? 'bg-[#E8FCF3] text-[#0EB869]' : 'text-slate-600 hover:bg-slate-50'}`}
                    >
                        <Bell size={18} />
                        Notifications
                    </button>
                    <button 
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 text-[14px] font-medium rounded-lg transition-colors ${activeTab === 'billing' ? 'bg-[#E8FCF3] text-[#0EB869]' : 'text-slate-600 hover:bg-slate-50'}`}
                    >
                        <CreditCard size={18} />
                        Billing & Plans
                    </button>
                ...
                <div className="animate-in fade-in duration-300">
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8 mb-6">
                        <div className="flex items-center justify-between mb-6">
                             ...
                             <Bot className="text-[#0EB869] h-8 w-8 opacity-20" />
                        </div>

                        <div className="space-y-6">
                            
                            {/* Facebook Ads Prompt */}
                            <div className="border border-slate-200 rounded-xl p-5 hover:border-[#86EFAC] transition-colors">
                                ...
                                <textarea 
                                    className="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg text-[13px] font-mono text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#0EB869]/20 focus:border-[#0EB869] leading-relaxed resize-y min-h-[120px]"
                                ...
                                <div className="flex items-center gap-3 mt-3">
                                    <button className="text-[12px] font-bold text-[#0EB869] hover:underline">Reset to Default</button>
                                </div>
                            </div>
                            ...
                            <div className="bg-[#E8FCF3] border border-[#86EFAC] rounded-xl p-5">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <input type="range" className="flex-1 h-2 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-[#0EB869]" />
                        ...
                        <div className="flex justify-end pt-6 border-t border-slate-100 mt-6 gap-3">
                            ...
                            <button className="flex items-center gap-2 px-6 py-2 rounded-lg bg-[#0EB869] text-white text-[13px] font-bold hover:bg-[#0B9655] transition-colors shadow-sm">
                                <Save size={16} />
                                Save Configuration
                            </button>
                        </div>
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8 mb-6">
                        ...
                        <div className="space-y-5 max-w-lg">
                            <div>
                                ...
                                <input type="text" defaultValue="Mike Sherry" className="w-full p-3 border border-slate-200 rounded-lg text-[14px] focus:outline-none focus:border-[#0EB869]" />
                            </div>
                            <div>
                                <label className="block text-[13px] font-bold text-slate-700 mb-2">Email Address</label>
                                <input type="email" defaultValue="mike@agency.com" className="w-full p-3 border border-slate-200 rounded-lg text-[14px] focus:outline-none focus:border-[#0EB869]" />
                            </div>
                            <div>
                                <label className="block text-[13px] font-bold text-slate-700 mb-2">Workspace Name</label>
                                <input type="text" defaultValue="Sherry Growth Systems" className="w-full p-3 border border-slate-200 rounded-lg text-[14px] focus:outline-none focus:border-[#0EB869]" />
                            </div>
                        </div>

                        <div className="flex justify-end pt-6 mt-6">
                            <button className="px-6 py-2 rounded-lg bg-[#0EB869] text-white text-[13px] font-bold hover:bg-[#0B9655] transition-colors shadow-sm">
                                Save Changes
                            </button>
                        </div>
                    </div>
            ...
            {activeTab === 'billing' && (
                <div className="animate-in fade-in duration-300">
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8 mb-6">
                        ...
                        <div className="bg-[#E8FCF3] border border-[#86EFAC] rounded-xl p-6 flex items-center justify-between mb-6">
                            <div>
                                <div className="text-[#0EB869] font-bold text-sm uppercase tracking-wide mb-1">Pro Plan</div>
    ...
    return (
        <div className="flex items-center justify-between py-3 border-b border-slate-50 last:border-0">
            ...
            <button 
                ...
                className={`w-11 h-6 rounded-full p-1 transition-colors relative ${isOn ? 'bg-[#0EB869]' : 'bg-slate-200'}`}
            >
